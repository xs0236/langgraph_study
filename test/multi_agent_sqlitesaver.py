...
# ========== 6. 【核心改动】用 with 语句包裹 SqliteSaver ==========

# ✅ 必须用 with 语句！from_conn_string 返回的是上下文管理器
with SqliteSaver.from_conn_string("team_checkpoints.db") as memory:
    ...
    print("\n" + "="*50)
    print("🚀 启动智能主管调度团队（SqliteSaver 持久化版）")
    print("="*50)
